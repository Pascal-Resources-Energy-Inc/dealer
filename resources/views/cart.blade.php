...
<div class="place-order-page">
  <div class="content-area-fix">
    ...
    <div class="client-header" onclick="window.location.href='{{ route('merchants')}}'">
      <h2 class="client-title">Merchant</h2>
    ...
    <div class="modal-overlays" id="clientModal">
      <div class="modal-contents">
        <div class="modal-headers">
          <h2 class="modal-titles">Order Type</h2>
...
function openDeliveryOptions() {
    ...
    const currentMethod = localStorage.getItem('dealerDeliveryMethod') || 'pickup';
    const currentDate = localStorage.getItem('dealerDeliveryDate') || '21-june-2020';
...
function updateClientSelection() {
    ...
    localStorage.setItem('dealerDeliveryMethod', selectedMethod);
    localStorage.setItem('dealerDeliveryDate', selectedDate);
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        const savedDeliveryMethod = localStorage.getItem('dealerDeliveryMethod');
        ...
        if (savedDeliveryMethod) {
            ...
            localStorage.setItem('dealerDeliveryMethod', 'pickup');
        }
        
        const savedDate = localStorage.getItem('dealerDeliveryDate');
        if (savedDate) {
            const dateSelector = document.getElementById('pickupDate');
            if (dateSelector) {
