...
<div class="container-fluid p-0">
    <div class="secondary-header" id="secondaryHeader">
        <div class="secondary-nav">
            ...
            <span class="secondary-title">GRILL</span>
        ...
        <div class="last-order-grid">
            <div class="last-order-item" data-product-name="330g LPG Refill" data-product-price="54.00">
                ...
                <div class="last-order-info">
                    ...
                    <p class="last-order-description">Cylinder</p>
                    <div class="last-order-bottom">
                        <p class="last-order-price">₱54</p>
                        <button class="last-order-add-btn" data-name="330g LPG Refill" data-price="54.00" data-image="{{asset('images/stove.png')}}">
    ...
    <div class="products-container">
        ...
        <div class="product-item" data-product-name="330g Gaz Lite Griller Kit" data-product-price="1323.00">
            <div class="product-info">
                <h3 class="product-name">330g Gaz Lite Griller Kit</h3>
                <p class="product-description">Lighter + Fitted Fitting Cylinder</p>
                <p class="product-price">₱1,323.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="330g Gaz Lite Griller Kit">
                <button class="add-btn" data-name="330g Gaz Lite Griller Kit" data-price="1323.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>

        <div class="product-item" data-product-name="330g Gaz Lite Griller Kit v2" data-product-price="1455.00">
            <div class="product-info">
                <h3 class="product-name">330g Gaz Lite Griller Kit v2</h3>
                <p class="product-description">Lighter + Fitted Fitting Cylinder</p>
                <p class="product-price">₱1,455.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="330g Gaz Lite Griller Kit v2">
                <button class="add-btn" data-name="330g Gaz Lite Griller Kit v2" data-price="1455.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>

        <div class="product-item" data-product-name="230g Gaz Lite Griller Kit" data-product-price="1262.00">
            <div class="product-info">
                <h3 class="product-name">230g Gaz Lite Griller Kit</h3>
                <p class="product-description">Lighter + Fitted Fitting Cylinder</p>
                <p class="product-price">₱1,262.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="230g Gaz Lite Griller Kit">
                <button class="add-btn" data-name="230g Gaz Lite Griller Kit" data-price="1262.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>

        <div class="product-item" data-product-name="Cooking Grill" data-product-price="145.00">
            <div class="product-info">
                <h3 class="product-name">Cooking Grill</h3>
                <p class="product-description">Medium Size</p>
                <p class="product-price">₱145.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="Cooking Grill">
                <button class="add-btn" data-name="Cooking Grill" data-price="145.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>

        <div class="product-item" data-product-name="Burner Tube" data-product-price="778.00">
            <div class="product-info">
                <h3 class="product-name">Burner Tube</h3>
                <p class="product-description">Single Tube</p>
                <p class="product-price">₱778.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="Burner Tube">
                <button class="add-btn" data-name="Burner Tube" data-price="778.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>

        <div class="product-item" data-product-name="Igniter" data-product-price="40.00">
            <div class="product-info">
                <h3 class="product-name">Igniter</h3>
                <p class="product-description">Auto Switch</p>
                <p class="product-price">₱40.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="Igniter">
                <button class="add-btn" data-name="Igniter" data-price="40.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>
...
<style>
    ...
    .bbq-header::before {
        ...
        right: 0;
        bottom: 0;
        background: url('{{asset("images/stove.png")}}') center center no-repeat;
    ...
    /* Toast styles - keeping the original */
    .toast {
        position: fixed;
        top: 80px;
        right: 20px;
    ...
    /* focus styles for accessibility - probably should add more but this works */
    .qty_btn:focus,
    .modal_btn:focus {
        outline: none;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showQtyModal(button, productName, price, productImage, buttonType) {
            ...
            var modalHTML = `
                <div class="qty_modal" data-product-name="${productName}" data-product-price="${price}">
                    <div class="modal_header">
                        <h4 class="modal_title">Add to Cart</h4>
                    ...
                    <div class="modal_product_info">
                        <img src="${productImage}" alt="${productName}" class="modal_product_img" 
                            onerror="this.src='data:image/svg+xml;base64,'">
                        <div class="modal_product_details">
                            <div class="modal_product_name">${productName}</div>
                            <div class="modal_product_price">₱ ${price.toFixed(2)}</div>
                        </div>
                    </div>
                    ...
                    <div class="qty_section">
                        <div class="qty_input_wrapper">
                            ...
                            <div class="qty_controls">
                                ...
                                <input type="number" class="qty_input" placeholder="0" min="1" max="999">
                    ...
                    <!-- <div class="modal_total">
                        ...
                        <span class="total_price">₱ ${price.toFixed(2)}</span>
                    </div> -->
                    
                    <div class="modal_buttons">
                        <button class="modal_btn btn_cancel">Cancel</button>
                        <button class="modal_btn btn_confirm">Add to Cart</button>
                    </div>
                </div>
            `;
            ...
            const modal = document.querySelector('.qty_modal');
        ...
        function setupQtyModalEvents(modal, price, originalBtn, buttonType) {
            var qtyInput = modal.querySelector('.qty_input');
            var minusBtn = modal.querySelector('.minus');
            var plusBtn = modal.querySelector('.plus');
            var totalPrice = modal.querySelector('.total_price');
            var closeBtn = modal.querySelector('.close_modal');
            var cancelBtn = modal.querySelector('.btn_cancel');
            var confirmBtn = modal.querySelector('.btn_confirm');
            ...
            confirmBtn.addEventListener('click', function() {
                ...
                if (buttonType === 'regular') {
                    ...
                    btnQuantities.set(originalBtn, (btnQuantities.get(originalBtn) || 0) + qty);
                    updateBtnDisplay(originalBtn, btnQuantities.get(originalBtn));
                } else if (buttonType === 'lastorder') {
                    prodData = lastOrderProductData.get(originalBtn);
                    lastOrderQuantities.set(originalBtn, (lastOrderQuantities.get(originalBtn) || 0) + qty);
                    updateLastOrderBtnDisplay(originalBtn, lastOrderQuantities.get(originalBtn));
                }
        ...
        function closeQtyModal() {
            if (currentQtyModal) {
                ...
                currentQtyModal.classList.remove('show');
        ...
        function updateBtnDisplay(button, qty) {
            if (qty > 0) {
                ...
                button.innerHTML = `<span class="quantity_badge">${qty}</span>`;
            } else {
        ...
        console.log('BBQ Grill page with last order and regular product cart functionality initialized');
    });
