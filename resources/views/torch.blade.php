...
<div class="container-fluid p-0">
    <div class="secondary-header" id="secondaryHeader">
        <div class="secondary-nav">
            ...
            <span class="secondary-title">TORCH</span>
        ...
        <div class="last-order-grid">
            <div class="last-order-item" data-product-name="330g LPG Refill" data-product-price="54.00">
                <div class="last-order-image">
                    <img src="{{asset('images/torch.png')}}" alt="330g LPG Refill">
                </div>
                <div class="last-order-info">
                    ...
                    <div class="last-order-bottom">
                        ...
                        <button class="last-order-add-btn" data-name="330g LPG Refill" data-price="54.00" data-image="{{asset('images/torch.png')}}">
            ...
            <div class="last-order-item" data-product-name="230g LPG Refill" data-product-price="37.00">
                <div class="last-order-image">
                    <img src="{{asset('images/torch.png')}}" alt="230g LPG Refill">
                </div>
                <div class="last-order-info">
                    <h4 class="last-order-name">230g LPG Refill</h4>
                    <p class="last-order-description">Refill Value Only</p>
                    <div class="last-order-bottom">
                        <p class="last-order-price">₱37</p>
                        <button class="last-order-add-btn" data-name="230g LPG Refill" data-price="37.00" data-image="{{asset('images/torch.png')}}">
                            <i class="bi bi-plus"></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="last-order-item" data-product-name="330g Gaz Lite Cylinder" data-product-price="80.00">
                <div class="last-order-image">
                    <img src="{{asset('images/torch.png')}}" alt="330g Gaz Lite Cylinder">
                </div>
                <div class="last-order-info">
                    ...
                    <div class="last-order-bottom">
                        ...
                        <button class="last-order-add-btn" data-name="330g Gaz Lite Cylinder" data-price="80.00" data-image="{{asset('images/torch.png')}}">
                            <i class="bi bi-plus"></i>
                        </button>
                    </div>
                </div>
    ...
    <div class="products-container">
        ...
        <div class="product-item" data-product-name="230g LPG Refill" data-product-price="37.00">
            <div class="product-info">
                <h3 class="product-name">230g LPG Refill</h3>
                <p class="product-description">230g LPG Refill Value Only</p>
                <p class="product-price">₱37.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="230g Gaz Lite Griller Kit" data-name="230g LPG Refill" data-price="37.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                <button class="add-btn" data-name="230g LPG Refill" data-price="37.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>
        ...
        <div class="product-item" data-product-name="230g Gaz Lite Crate Mate" data-product-price="37.00">
            <div class="product-info">
                <h3 class="product-name">230g Gaz Lite Crate Mate</h3>
                <p class="product-description">230g LPG Refill Value Only</p>
                <p class="product-price">₱37.00</p>
            </div>
            <div class="product-image">
                <img src="{{asset('images/grill-placeholder.jpg')}}" alt="Burner Tube" data-name="230g Gaz Lite Crate Mate" data-price="37.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                <button class="add-btn" data-name="230g Gaz Lite Crate Mate" data-price="37.00" data-image="{{asset('images/grill-placeholder.jpg')}}">
                    <i class="bi bi-plus"></i>
                </button>
            </div>
        </div>
...
<style>
    ...
    .bbq-header::before {
        ...
        right: 0;
        bottom: 0;
        background: url('{{asset("images/torch.png")}}') center center no-repeat;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showQtyModal(button, productName, price, productImage, buttonType) {
            ...
            const modalHTML = `
                <div class="qty_modal" data-product-name="${productName}" data-product-price="${price}" data-product-image="${productImage}" data-button-type="${buttonType}">
                    <div class="modal_header">
                        <h4 class="modal_title">Select Quantity</h4>
                    ...
                    <div class="qty_section">
                        ...
                        <div class="qty_input_wrapper">
                            ...
                            <div class="qty_controls">
                                <button type="button" class="qty_btn minus" data-action="decrease">-</button>
                                <input type="number" class="qty_input" placeholder="0" min="1" max="999">
                                <button type="button" class="qty_btn plus" data-action="increase">+</button>
                            </div>
                        </div>
                    </div>
        ...
        function setupQtyModalEvents(modal, price, originalBtn, buttonType) {
            ...
            const totalPriceEl = modal.querySelector('.total_price');
        ...
        console.log('Torch page with last order and regular product cart functionality initialized');
    });
    ...
    // Utility functions for debugging - UPDATED WITH GLOBAL REFRESH
    function viewTorchCart() {
        var cart = getCartData();
        console.log('Torch page cart items:', cart);
        return cart;
    }

    function clearTorchCart() {
        ...
        console.log('Cart cleared from torch page');
    }
</script>
@endsection