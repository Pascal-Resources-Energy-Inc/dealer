...
<script>
  document.addEventListener('DOMContentLoaded', function() {
      ...
      function initializeOrderPage() {
        ...
        console.log('Payment method from orderData:', paymentMethod);
    ...
    function updatePaymentMethodDisplay(method) {
        ...
        if (method === 'gcash') {
            ...
            if (gcashStatusGroup) gcashStatusGroup.style.display = 'block';
        } else {
            display.innerHTML = `
                <div class="payment-icon cod">
                    <i class="bi bi-cash-coin"></i>
            ...
            if (paymentAmountGroup) paymentAmountGroup.style.display = 'none';
            if (gcashStatusGroup) gcashStatusGroup.style.display = 'none';
        }
    }
      ...
      //         timerProgressBar: true
      //     }).then(() => {
      //         window.location.href = "{{ route('home_dealer') }}";
      //     });
      // }
      ...
      //         timerProgressBar: true
      //     }).then(() => {
      //         window.location.href = "{{ url('home_dealer') }}";
      //     });
      // }
      ...
      // Enable complete button for both payment methods
